...
# note: Dec 16, 2024
# add columns cal_n, cal_p, cal_s to the table
...
for (i in 1:length(list_excel_files)) {
  ...
  if (!i %in% c(1,4,8,12,13,20,25,28)) {
    ...
    max.re.vertex.flexex <- max(select(elbow.vertex,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.vertex.flexex <- min(select(elbow.vertex,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.occiput.flexex <- max(select(elbow.occiput,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.occiput.flexex <- min(select(elbow.occiput,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.canthus.flexex <- max(select(elbow.canthus,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.canthus.flexex <- min(select(elbow.canthus,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.cbone.flexex <- max(select(elbow.cbone,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.cbone.flexex <- min(select(elbow.cbone,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.sternum.flexex <- max(select(elbow.sternum,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.sternum.flexex <- min(select(elbow.sternum,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.buckle.flexex <- max(select(elbow.buckle,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.buckle.flexex <- min(select(elbow.buckle,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.scapula.flexex <- max(select(elbow.scapula,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.scapula.flexex <- min(select(elbow.scapula,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.sacrum.flexex <- max(select(elbow.sacrum,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.sacrum.flexex <- min(select(elbow.sacrum,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.door.flexex <- max(select(elbow.door,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.door.flexex <- min(select(elbow.door,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.pubis.flexex <- max(select(elbow.pubis,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.pubis.flexex <- min(select(elbow.pubis,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.shoe.flexex <- max(select(elbow.shoe,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.shoe.flexex <- min(select(elbow.shoe,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.keys.flexex <- max(select(elbow.keys,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.keys.flexex <- min(select(elbow.keys,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.mouse.flexex <- max(select(elbow.mouse,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.mouse.flexex <- min(select(elbow.mouse,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.desk.flexex <- max(select(elbow.desk,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.desk.flexex <- min(select(elbow.desk,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.desk.ear.flexex <- max(select(elbow.desk.ear,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.desk.ear.flexex <- min(select(elbow.desk.ear,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.mobile.flexex <- max(select(elbow.mobile,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.mobile.flexex <- min(select(elbow.mobile,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.mobile.ear.flexex <- max(select(elbow.mobile.ear,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.mobile.ear.flexex <- min(select(elbow.mobile.ear,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.cut.flexex <- max(select(elbow.cut,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.cut.flexex <- min(select(elbow.cut,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.fork.flexex <- max(select(elbow.fork,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.fork.flexex <- min(select(elbow.fork,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.folder.flexex <- max(select(elbow.folder,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.folder.flexex <- min(select(elbow.folder,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.jar.flexex <- max(select(elbow.jar,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.jar.flexex <- min(select(elbow.jar,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.drink.flexex <- max(select(elbow.drink,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.drink.flexex <- min(select(elbow.drink,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    max.re.stand.flexex <- max(select(elbow.stand,"Right Elbow Pronation/Supination"), na.rm = T)
    min.re.stand.flexex <- min(select(elbow.stand,"Right Elbow Pronation/Supination"), na.rm = T)
    re.stand.flexex.range <-max.re.stand.flexex-min.re.stand.flexex
    
    # All the code to record max and mins for neutral
    neutral <- apply(all.elbow.markers,1,function(row) any(row %like% "cal_n"))
    neutral.true <- all.elbow.markers[neutral,]
    cal_n1 <- max(as.data.frame(neutral.true[1]), na.rm = T)
    
    elbow.neutral <- subset(both.elbows,Frame == cal_n1)
    
    min.re.neutral.flexex <- min(select(elbow.neutral,"Right Elbow Pronation/Supination"), na.rm = T)

    
    # All the code to record max and mins for full pronation
    full.pronation <- apply(all.elbow.markers,1,function(row) any(row %like% "cal_p"))
    full.pronation.true <- all.elbow.markers[full.pronation,]
    cal_p1 <- max(as.data.frame(full.pronation.true[1]), na.rm = T)
    
    elbow.full.pronation <- subset(both.elbows,Frame == cal_p1)
    
    min.re.full.pronation.flexex <- min(select(elbow.full.pronation,"Right Elbow Pronation/Supination"), na.rm = T)

    
    # All the code to record max and mins for full supination
    full.supination <- apply(all.elbow.markers,1,function(row) any(row %like% "cal_s"))
    full.supination.true <- all.elbow.markers[full.supination,]
    cal_s1 <- max(as.data.frame(full.supination.true[1]), na.rm = T)
    
    elbow.full.supination <- subset(both.elbows,Frame == cal_s1)
    
    min.re.full.supination.flexex <- min(select(elbow.full.supination,"Right Elbow Pronation/Supination"), na.rm = T)
    ...
    re.flexex.min.list <-c(i, min.re.vertex.flexex,min.re.occiput.flexex,min.re.canthus.flexex,
                           ...
                           min.re.cut.flexex, min.re.fork.flexex, min.re.folder.flexex, min.re.jar.flexex, min.re.drink.flexex, min.re.stand.flexex, min.re.neutral.flexex,
                           min.re.full.pronation.flexex, min.re.full.supination.flexex)
    ...
    re.flexex.combo.list <- c(i, 
                              ...
                              min.re.neutral.flexex,
                              min.re.full.pronation.flexex,
                              min.re.full.supination.flexex
    )
    ...
    max.re.vertex.flexex <- max(select(elbow.vertex,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.vertex.flexex <- min(select(elbow.vertex,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.vertex.flexex.range <- max.re.vertex.flexex - min.re.vertex.flexex
    ...
    max.re.occiput.flexex <- max(select(elbow.occiput,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.occiput.flexex <- min(select(elbow.occiput,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.occiput.flexex.range <-max.re.occiput.flexex-min.re.occiput.flexex
    ...
    max.re.canthus.flexex <- max(select(elbow.canthus,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.canthus.flexex <- min(select(elbow.canthus,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.canthus.flexex.range <-max.re.canthus.flexex-min.re.canthus.flexex
    ...
    max.re.cbone.flexex <- max(select(elbow.cbone,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.cbone.flexex <- min(select(elbow.cbone,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.cbone.flexex.range <-max.re.cbone.flexex-min.re.cbone.flexex
    ...
    max.re.sternum.flexex <- max(select(elbow.sternum,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.sternum.flexex <- min(select(elbow.sternum,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.sternum.flexex.range <-max.re.sternum.flexex-min.re.sternum.flexex
    ...
    max.re.buckle.flexex <- max(select(elbow.buckle,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.buckle.flexex <- min(select(elbow.buckle,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.buckle.flexex.range <-max.re.buckle.flexex-min.re.buckle.flexex
    ...
    max.re.scapula.flexex <- max(select(elbow.scapula,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.scapula.flexex <- min(select(elbow.scapula,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.scapula.flexex.range <-max.re.scapula.flexex-min.re.scapula.flexex
    ...
    max.re.sacrum.flexex <- max(select(elbow.sacrum,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.sacrum.flexex <- min(select(elbow.sacrum,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.sacrum.flexex.range <-max.re.sacrum.flexex-min.re.sacrum.flexex
    ...
    max.re.door.flexex <- max(select(elbow.door,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.door.flexex <- min(select(elbow.door,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.door.flexex.range <-max.re.door.flexex-min.re.door.flexex
    ...
    max.re.pubis.flexex <- max(select(elbow.pubis,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.pubis.flexex <- min(select(elbow.pubis,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.pubis.flexex.range <-max.re.pubis.flexex-min.re.pubis.flexex
    ...
    max.re.shoe.flexex <- max(select(elbow.shoe,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.shoe.flexex <- min(select(elbow.shoe,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.shoe.flexex.range <-max.re.shoe.flexex-min.re.shoe.flexex
    ...
    max.re.keys.flexex <- max(select(elbow.keys,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.keys.flexex <- min(select(elbow.keys,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.keys.flexex.range <-max.re.keys.flexex-min.re.keys.flexex
    ...
    max.re.mouse.flexex <- max(select(elbow.mouse,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.mouse.flexex <- min(select(elbow.mouse,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.mouse.flexex.range <-max.re.mouse.flexex-min.re.mouse.flexex
    ...
    max.re.desk.flexex <- max(select(elbow.desk,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.desk.flexex <- min(select(elbow.desk,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.desk.flexex.range <-max.re.desk.flexex-min.re.desk.flexex
    ...
    max.re.desk.ear.flexex <- max(select(elbow.desk.ear,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.desk.ear.flexex <- min(select(elbow.desk.ear,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.desk.ear.flexex.range <-max.re.desk.ear.flexex-min.re.desk.ear.flexex
    ...
    max.re.mobile.flexex <- max(select(elbow.mobile,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.mobile.flexex <- min(select(elbow.mobile,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.mobile.flexex.range <-max.re.mobile.flexex-min.re.mobile.flexex
    ...
    max.re.mobile.ear.flexex <- max(select(elbow.mobile.ear,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.mobile.ear.flexex <- min(select(elbow.mobile.ear,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.mobile.ear.flexex.range <-max.re.mobile.ear.flexex-min.re.mobile.ear.flexex
    ...
    max.re.cut.flexex <- max(select(elbow.cut,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.cut.flexex <- min(select(elbow.cut,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.cut.flexex.range <-max.re.cut.flexex-min.re.cut.flexex
    ...
    max.re.fork.flexex <- max(select(elbow.fork,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.fork.flexex <- min(select(elbow.fork,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.fork.flexex.range <-max.re.fork.flexex-min.re.fork.flexex
    ...
    max.re.folder.flexex <- max(select(elbow.folder,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.folder.flexex <- min(select(elbow.folder,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.folder.flexex.range <-max.re.folder.flexex-min.re.folder.flexex
    ...
    max.re.jar.flexex <- max(select(elbow.jar,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.jar.flexex <- min(select(elbow.jar,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.jar.flexex.range <-max.re.jar.flexex-min.re.jar.flexex
    ...
    max.re.drink.flexex <- max(select(elbow.drink,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.drink.flexex <- min(select(elbow.drink,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.drink.flexex.range <-max.re.drink.flexex-min.re.drink.flexex
    ...
    max.re.stand.flexex <- max(select(elbow.stand,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    min.re.stand.flexex <- min(select(elbow.stand,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    re.stand.flexex.range <-max.re.stand.flexex-min.re.stand.flexex
    ...
    min.re.neutral.flexex <- min(select(elbow.neutral,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    if (min.re.neutral.flexex < -5) {
      min.re.neutral.flexex <- -5
    } else {
      min.re.neutral.flexex <- min.re.neutral.flexex
    } 
    ...
    min.re.full.pronation.flexex <- min(select(elbow.full.pronation,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    if (min.re.full.pronation.flexex < -5) {
      min.re.full.pronation.flexex <- -5
    } else {
      min.re.full.pronation.flexex <- min.re.full.pronation.flexex
    } 
    ...
    min.re.full.supination.flexex <- min(select(elbow.full.supination,"Right Elbow Pronation/Supination"), na.rm = T) - 180
    if (min.re.full.supination.flexex < -5) {
      min.re.full.supination.flexex <- -5
    } else {
      min.re.full.supination.flexex <- min.re.full.supination.flexex
    } 
...
write.csv(final_results_table_flexex_re, "Results/Results_all_patients_neg5_re_pronosup_v3.csv", row.names = F)
