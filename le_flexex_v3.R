...
for (i in 1:length(list_excel_files)) {
  ...
  if (!i %in% c(1,4,8,12,13,20,25,28)) {
    ...
    max.re.vertex.flexex <- max(select(elbow.vertex,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.vertex.flexex <- min(select(elbow.vertex,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.occiput.flexex <- max(select(elbow.occiput,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.occiput.flexex <- min(select(elbow.occiput,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.canthus.flexex <- max(select(elbow.canthus,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.canthus.flexex <- min(select(elbow.canthus,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.cbone.flexex <- max(select(elbow.cbone,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.cbone.flexex <- min(select(elbow.cbone,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.sternum.flexex <- max(select(elbow.sternum,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.sternum.flexex <- min(select(elbow.sternum,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.buckle.flexex <- max(select(elbow.buckle,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.buckle.flexex <- min(select(elbow.buckle,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.scapula.flexex <- max(select(elbow.scapula,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.scapula.flexex <- min(select(elbow.scapula,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.sacrum.flexex <- max(select(elbow.sacrum,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.sacrum.flexex <- min(select(elbow.sacrum,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.door.flexex <- max(select(elbow.door,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.door.flexex <- min(select(elbow.door,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.pubis.flexex <- max(select(elbow.pubis,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.pubis.flexex <- min(select(elbow.pubis,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.shoe.flexex <- max(select(elbow.shoe,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.shoe.flexex <- min(select(elbow.shoe,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.keys.flexex <- max(select(elbow.keys,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.keys.flexex <- min(select(elbow.keys,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.mouse.flexex <- max(select(elbow.mouse,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.mouse.flexex <- min(select(elbow.mouse,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.desk.flexex <- max(select(elbow.desk,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.desk.flexex <- min(select(elbow.desk,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.desk.ear.flexex <- max(select(elbow.desk.ear,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.desk.ear.flexex <- min(select(elbow.desk.ear,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.mobile.flexex <- max(select(elbow.mobile,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.mobile.flexex <- min(select(elbow.mobile,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.mobile.ear.flexex <- max(select(elbow.mobile.ear,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.mobile.ear.flexex <- min(select(elbow.mobile.ear,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.cut.flexex <- max(select(elbow.cut,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.cut.flexex <- min(select(elbow.cut,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.fork.flexex <- max(select(elbow.fork,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.fork.flexex <- min(select(elbow.fork,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.folder.flexex <- max(select(elbow.folder,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.folder.flexex <- min(select(elbow.folder,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.jar.flexex <- max(select(elbow.jar,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.jar.flexex <- min(select(elbow.jar,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.drink.flexex <- max(select(elbow.drink,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.drink.flexex <- min(select(elbow.drink,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.stand.flexex <- max(select(elbow.stand,"Left Elbow Flexion/Extension"), na.rm = T)
    min.re.stand.flexex <- min(select(elbow.stand,"Left Elbow Flexion/Extension"), na.rm = T)
    ...
    max.re.vertex.flexex <- max(select(elbow.vertex,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.vertex.flexex <- min(select(elbow.vertex,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.vertex.flexex.range <- max.re.vertex.flexex - min.re.vertex.flexex
    ...
    max.re.occiput.flexex <- max(select(elbow.occiput,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.occiput.flexex <- min(select(elbow.occiput,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.occiput.flexex.range <-max.re.occiput.flexex-min.re.occiput.flexex
    ...
    max.re.canthus.flexex <- max(select(elbow.canthus,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.canthus.flexex <- min(select(elbow.canthus,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.canthus.flexex.range <-max.re.canthus.flexex-min.re.canthus.flexex
    ...
    max.re.cbone.flexex <- max(select(elbow.cbone,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.cbone.flexex <- min(select(elbow.cbone,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.cbone.flexex.range <-max.re.cbone.flexex-min.re.cbone.flexex
    ...
    max.re.sternum.flexex <- max(select(elbow.sternum,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.sternum.flexex <- min(select(elbow.sternum,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.sternum.flexex.range <-max.re.sternum.flexex-min.re.sternum.flexex
    ...
    max.re.buckle.flexex <- max(select(elbow.buckle,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.buckle.flexex <- min(select(elbow.buckle,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.buckle.flexex.range <-max.re.buckle.flexex-min.re.buckle.flexex
    ...
    max.re.scapula.flexex <- max(select(elbow.scapula,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.scapula.flexex <- min(select(elbow.scapula,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.scapula.flexex.range <-max.re.scapula.flexex-min.re.scapula.flexex
    ...
    max.re.sacrum.flexex <- max(select(elbow.sacrum,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.sacrum.flexex <- min(select(elbow.sacrum,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.sacrum.flexex.range <-max.re.sacrum.flexex-min.re.sacrum.flexex
    ...
    max.re.door.flexex <- max(select(elbow.door,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.door.flexex <- min(select(elbow.door,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.door.flexex.range <-max.re.door.flexex-min.re.door.flexex
    ...
    max.re.pubis.flexex <- max(select(elbow.pubis,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.pubis.flexex <- min(select(elbow.pubis,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.pubis.flexex.range <-max.re.pubis.flexex-min.re.pubis.flexex
    ...
    max.re.shoe.flexex <- max(select(elbow.shoe,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.shoe.flexex <- min(select(elbow.shoe,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.shoe.flexex.range <-max.re.shoe.flexex-min.re.shoe.flexex
    ...
    max.re.keys.flexex <- max(select(elbow.keys,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.keys.flexex <- min(select(elbow.keys,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.keys.flexex.range <-max.re.keys.flexex-min.re.keys.flexex
    ...
    max.re.mouse.flexex <- max(select(elbow.mouse,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.mouse.flexex <- min(select(elbow.mouse,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.mouse.flexex.range <-max.re.mouse.flexex-min.re.mouse.flexex
    ...
    max.re.desk.flexex <- max(select(elbow.desk,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.desk.flexex <- min(select(elbow.desk,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.desk.flexex.range <-max.re.desk.flexex-min.re.desk.flexex
    ...
    max.re.desk.ear.flexex <- max(select(elbow.desk.ear,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.desk.ear.flexex <- min(select(elbow.desk.ear,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.desk.ear.flexex.range <-max.re.desk.ear.flexex-min.re.desk.ear.flexex
    ...
    max.re.mobile.flexex <- max(select(elbow.mobile,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.mobile.flexex <- min(select(elbow.mobile,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.mobile.flexex.range <-max.re.mobile.flexex-min.re.mobile.flexex
    ...
    max.re.mobile.ear.flexex <- max(select(elbow.mobile.ear,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.mobile.ear.flexex <- min(select(elbow.mobile.ear,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.mobile.ear.flexex.range <-max.re.mobile.ear.flexex-min.re.mobile.ear.flexex
    ...
    max.re.cut.flexex <- max(select(elbow.cut,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.cut.flexex <- min(select(elbow.cut,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.cut.flexex.range <-max.re.cut.flexex-min.re.cut.flexex
    ...
    max.re.fork.flexex <- max(select(elbow.fork,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.fork.flexex <- min(select(elbow.fork,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.fork.flexex.range <-max.re.fork.flexex-min.re.fork.flexex
    ...
    max.re.folder.flexex <- max(select(elbow.folder,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.folder.flexex <- min(select(elbow.folder,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.folder.flexex.range <-max.re.folder.flexex-min.re.folder.flexex
    ...
    max.re.jar.flexex <- max(select(elbow.jar,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.jar.flexex <- min(select(elbow.jar,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.jar.flexex.range <-max.re.jar.flexex-min.re.jar.flexex
    ...
    max.re.drink.flexex <- max(select(elbow.drink,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.drink.flexex <- min(select(elbow.drink,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.drink.flexex.range <-max.re.drink.flexex-min.re.drink.flexex
    ...
    max.re.stand.flexex <- max(select(elbow.stand,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    min.re.stand.flexex <- min(select(elbow.stand,"Left Elbow Flexion/Extension"), na.rm = T) - 180
    re.stand.flexex.range <-max.re.stand.flexex-min.re.stand.flexex
...
write.csv(final_results_table_flexex_re, "Results/Results_all_patients_neg5_le_flexex_v3.csv", row.names = F)
